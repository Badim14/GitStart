...
namespace GitStart.Tests
{
    public class DatabaseTests
    {
        ...
        // Метод для генерации уникального имени базы данных для каждого теста
        ...
        public DatabaseTests()
        {
            ...
            // Удаляем старую базу данных перед тестами, если она существует
            if (File.Exists(databaseFileName))
            {
                File.Delete(databaseFileName);
            }

            // Настройка контекста для тестирования с уникальной базой данных
            ...
            {
                context.Database.EnsureDeleted(); // Убедитесь, что база данных удалена
                context.Database.EnsureCreated(); // Создайте новую базу данных
            }
        }
